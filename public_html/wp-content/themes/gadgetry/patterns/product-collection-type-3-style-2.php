<?php
/**
 * Title: Products Collection (Top Rated T3S2)
 * Slug: gadgetry/product-collection-type-3-style-2
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<!-- wp:woocommerce/product-top-rated {"columns":4,"rows":2,"align":"wide","className":"is-style-gadgetry-product-button-type-1-style-1"} /-->
</div>
<!-- /wp:group -->