<?php
/**
 * Title: Products Collection (Newest T1S2)
 * Slug: gadgetry/product-collection-type-1-style-2
...
<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<!-- wp:woocommerce/product-new {"columns":4,"rows":1,"orderby":"popularity","align":"wide","className":"is-style-gadgetry-product-button-type-1-style-1"} /-->
</div>
<!-- /wp:group -->
