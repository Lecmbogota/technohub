<?php
/**
 * Title: Advertisement (T5S1)
 * Slug: gadgetry/advertisement-type-5-style-1
...
<div class="wp-block-group">
	...
	<div class="wp-block-cover aligncenter is-light" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16);min-height:250px">
		...
		<div class="wp-block-cover__inner-container">
			...
			<p class="has-text-align-center has-gray-500-color has-text-color has-link-color has-x-small-font-size" style="text-transform:uppercase"><?php esc_html_e( '970 x 250', 'gadgetry' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
	</div>
	<!-- /wp:cover -->
