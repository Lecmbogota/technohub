...
/**
 * Title: Banner (T2S1)
 * Slug: gadgetry/banner-type-2-style-1
 * Categories: banner, call-to-action, featured
 * Viewport width: 1280
 * Description: A hero section with a title, a paragraph, a CTA button, and background image.
 *
 * @package gadgetry
 */
...
<!-- wp:group {"metadata":{"name":"Banner"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}},"color":{"background":"#000000"},"background":{"backgroundImage":{"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/dark-sample-1920x1200.webp' ) ); ?>","source":"file","title":"Placeholder Image"},"backgroundPosition":"50% 49%"}},"layout":{"type":"constrained"}} -->
