 ...
 * Slug: gadgetry/taxonomy-product-tag
 * Inserter: no
 *
 * @package gadgetry
 */
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:0">
	...
	<!-- wp:group {"metadata":{"name":"Product Listing"},"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
