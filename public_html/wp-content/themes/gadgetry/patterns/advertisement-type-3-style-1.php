<?php
/**
 * Title: Advertisement (T3S1)
 * Slug: gadgetry/advertisement-type-3-style-1
...
<!-- wp:group {"style":{"dimensions":{"minHeight":"90px"}},"layout":{"type":"constrained","contentSize":"728px"}} -->
<div class="wp-block-group" style="min-height:90px">
	<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/dark-sample-1920x1200.webp' ) ); ?>","dimRatio":0,"overlayColor":"primary-500","isUserOverlayColor":true,"minHeight":90,"isDark":false,"align":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|16","bottom":"var:preset|spacing|16"},"blockGap":"var:preset|spacing|8"}},"layout":{"type":"constrained","contentSize":"728px"}} -->
	<div class="wp-block-cover aligncenter is-light" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16);min-height:90px">
		...
		<div class="wp-block-cover__inner-container">
			...
			<p class="has-text-align-center has-gray-500-color has-text-color has-link-color has-x-small-font-size" style="text-transform:uppercase"><?php esc_html_e( '728 x 90', 'gadgetry' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
	</div>
	<!-- /wp:cover -->
