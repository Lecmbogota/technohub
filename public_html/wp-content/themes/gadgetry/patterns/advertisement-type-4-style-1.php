<?php
/**
 * Title: Advertisement (T4S1)
 * Slug: gadgetry/advertisement-type-4-style-1
...
<!-- wp:group {"style":{"dimensions":{"minHeight":""}},"layout":{"type":"constrained","contentSize":"300px","justifyContent":"center"}} -->
<div class="wp-block-group">
	<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( 'assets/images/dark-sample-1920x1200.webp' ) ); ?>","dimRatio":0,"overlayColor":"primary-500","isUserOverlayColor":true,"minHeight":606,"minHeightUnit":"px","isDark":false,"align":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|16","bottom":"var:preset|spacing|16"},"blockGap":"var:preset|spacing|8"}},"layout":{"type":"constrained","contentSize":"300px"}} -->
	<div class="wp-block-cover aligncenter is-light" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16);min-height:606px">
		...
		<div class="wp-block-cover__inner-container">
			...
			<p class="has-text-align-center has-gray-500-color has-text-color has-link-color has-x-small-font-size" style="text-transform:uppercase"><?php esc_html_e( '300 x 600', 'gadgetry' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
	</div>
	<!-- /wp:cover -->
